...
const Winner: FC<WinnerType> = ({ winnerName }) => {
    return (
        <div className="animate-[scaleAnim_0.5s_ease-in-out] mt-[5%] flex  items-center flex-col gap-4 ">
            <div className="w-full flex justify-center">
                <Image alt="winner logo" src={crown} height={100} width={200} />
            </div>
            <h2 className="text-3xl pixel font-bold ">Winner!!!</h2>

            <h3 className="text-xl  font-bold  dark:staticStyleYellow mb-2">
                {winnerName}
            </h3>
            <div className="p-4 upStyleNoAnim dark:upStyleNoAnimDark text-2xl w-[300px] relative h-[300px] overflow-hidden  text-center">
