...
const QuestionMark: FC<QuestionMarkType> = () => {
    ...
    return (
        <div className="flex gap-3 justify-center relative flex-col items-center animate-[scaleAnim_0.5s_ease-in-out] ">
            <div>
                {" "}
                <svg
                    width="170px"
            ...
            <p className="text-[25px] w-full">{t("writeNameOfTheSong")}</p>
        </div>
    );
};
